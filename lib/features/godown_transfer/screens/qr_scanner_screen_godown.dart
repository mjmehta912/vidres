...
class QrScannerScreenGodown extends StatefulWidget {
  final Function(String) onScanResult;
  final Set<String> existingCardNumbers;

  const QrScannerScreenGodown({
    super.key,
  ...
  @override
  State<QrScannerScreenGodown> createState() => _QrScannerScreenGodownState();
}

class _QrScannerScreenGodownState extends State<QrScannerScreenGodown> {
